                              ...
                              if (!_useGeolocation) ...[
                                TextField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: 'Localidad',
                                    hintText:
                                        'Ej: Santiago, Providencia, Viña del Mar',
                                    prefixIcon: const Icon(Icons.location_city),
                                    border: const OutlineInputBorder(),
                                    helperText:
                                        'Ingresa una comuna o ciudad de Chile',
                                  ),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Slider(
                                  ...
                                  divisions:
                                      AppConstants.radiusOptions.length - 1,
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () async {
                        ...
                        final nuevoModo = themeService.isDarkMode
                            ? 'light'
                            : 'dark';
                        ...
                        await AnalyticsService.logCambioTema(
                          modoTema: nuevoModo,
                        );
                      },
      ...
      if (_useGeolocation) {
        ...
        switch (locationStatus) {
          ...
          case LocationStatus.permissionDeniedPermanently:
            setState(() {
              _errorMessage =
                  'Los permisos de ubicación fueron denegados permanentemente. Por favor, actívalos en la configuración de la aplicación.';
            });
            return;
          case LocationStatus.unknown:
            setState(() {
              _errorMessage =
                  'Error desconocido con la ubicación. Por favor, intenta nuevamente.';
            });
            return;
